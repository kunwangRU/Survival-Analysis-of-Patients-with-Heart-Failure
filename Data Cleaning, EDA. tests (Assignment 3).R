...
#Loading dataset
rawdata <-read.csv("C:/Users/wangk/Desktop/Rutgers/Rutgers Courseware/Fall 2020/Multivariate Analysis/Assignment 3/heart_failure_clinical_records_dataset.csv")
View(rawdata)
